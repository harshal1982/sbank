...
Converge.prototype.refundPayment = function (transid,amount) {
    ...
    xmlTransaction += '<ssl_test_mode>false</ssl_test_mode>\n';
    xmlTransaction += '<ssl_transaction_type>ccreturn</ssl_transaction_type>\n';
    xmlTransaction += '<ssl_txn_id>' + transid + '</ssl_txn_id>\n';
...
Converge.prototype.foreignCurrPayment = function (id, flag, amount) {
    ...
    xmlTransaction += 'xmldata=<txn>\n';
    xmlTransaction += '<ssl_test_mode>false</ssl_test_mode>\n';
    xmlTransaction += '<ssl_amount>216</ssl_amount>\n';
    xmlTransaction += '<ID>5196f3d017c29e39fb50a57133acb4f101641260</ID>\n';
    xmlTransaction += '<dccoption>N</dccoption>\n';
    xmlTransaction += '</txn>\n';
...
Converge.prototype.collectPayment2 = function (firstName, lastName, email, cardNumber, expirationMonth, expirationYear, cvv, amount, invoiceNumber, description) {
...
Converge.prototype.collectPayment2Debit = function (firstName, lastName, email, cardNumber, expirationMonth, expirationYear, cvv, amount, invoiceNumber, description) {
    ...
    xmlTransaction += '<ssl_card_number>' + cardNumber + '</ssl_card_number>\n';
    xmlTransaction += '<ssl_exp_date>' + expirationMonth + expirationYear + '</ssl_exp_date>\n';
    xmlTransaction += '<ssl_account_type>1</ssl_account_type>\n';
    xmlTransaction += '<ssl_transaction_type>pldpurchase</ssl_transaction_type>\n';
    xmlTransaction += '<ssl_customer_number>1</ssl_customer_number>\n';
    xmlTransaction += '<ssl_amount>' + amount + '</ssl_amount>\n';
    xmlTransaction += '<ssl_cvv2cvc2>' + cvv + '</ssl_cvv2cvc2>\n';
    xmlTransaction += '</txn>\n';
